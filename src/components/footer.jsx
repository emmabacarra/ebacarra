    ...
    return (
        <footer className="mt-auto min-w-full">
            <div className="flex justify-between items-start mt-2 p-10 bg-brown">
                <div className="ml-5">
                    <img className="full-logo" src="../public/imgs/full logo.svg" alt="emma full logo" />
                    <div className="contacts flex">
                        ...
                        <div className="social-links flex gap-8 mt-5 mx-3">
                            <a href=""><i className="fa-brands fa-linkedin-in text-skin text-4xl"></i></a>
                            <a href=""><i className="fa-brands fa-github text-skin text-4xl"></i></a>
                        </div>
                    </div>
                </div>
